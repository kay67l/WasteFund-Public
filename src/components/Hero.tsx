...
const Hero: FC<HeroProps> = ({ onRegisterSchool, onPartnerInquiry }) => {
  return (
        ...
        <div className="hero-inner">
          <div className="hero-content">
            <div className="hero-badge">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4.5 8-11.8A8 8 0 0 0 6.5 2.5C4.2 4.3 2 8.5 2 12.2 2 16 8 17.5 8 17.5"/><circle cx="12" cy="9" r="2.5"/></svg>
